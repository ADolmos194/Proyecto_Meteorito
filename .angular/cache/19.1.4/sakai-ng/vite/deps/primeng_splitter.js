...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(SplitterPanel, {
    className: "SplitterPanel",
    filePath: "splitter.ts",
    lineNumber: 20
  });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(Splitter, {
    className: "Splitter",
    filePath: "splitter.ts",
    lineNumber: 82
  });
...
(function() {
  (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(SplitterModule, {
    imports: [Splitter, SplitterPanel, SharedModule],
    exports: [Splitter, SplitterPanel, SharedModule]
  });
})();
